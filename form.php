...
<form action="." method="POST">
    ...
    <select  name="abilities[]" multiple  <?php if ($errors['abilities']) {print 'class="error"';} ?> >
        ...
        <option value="1" <?php if ($values['abilities'][0]) {print 'selected';} ?>>Бессмертие</option>
        <option value="2" <?php if ($values['abilities'][1]) {print 'selected';} ?>>Прохождение сквозь стен</option>
        <option value="3" <?php if ($values['abilities'][2]) {print 'selected';} ?>>Левитация</option>
        <option value="4" <?php if ($values['abilities'][3]) {print 'selected';} ?>>Невидимость</option>
